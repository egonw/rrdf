---
title: "A short tutorial on rrdf"
...
vignette: >
  ...
  %\VignetteKeywords{triple, SPARQL, Semantic Web}
...
I would add support for that to R [@Willighagen2011]. That was in 2011. This package does just that, and allows
to work with RDF data and perform SPARQL queries. I am indebted to Rajarshi Guha, whos rcdk
package provided me with a template to create this package from [@Guha2007].

This tutorial will demo in two sections how RDF can be handles and how SPARQL [@Seaborne2009] functionality
can be used.
...
basically just handles triples. Both can be created with the *new.rdf* command:
...
a data file. This is done with the *load.rdf* method. Let's read this file:
...
We demonstrate the SPARQL functionality with the alkane data loaded in Section [sec:loading]. For example,
